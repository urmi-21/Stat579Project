...
knitr::opts_chunk$set(echo = TRUE,message = FALSE,warning = FALSE,cache = T,tidy.opts=list(width.cutoff=60),tidy=TRUE)
...
```{r fig2, fig.width=8, fig.height=8,cache=FALSE,warning=FALSE,message=FALSE,results="hide", fig.cap="\\label{fig:fig2}plotting by race"}
...
Figure \ref{fig:fig2} shows the top mutated genes for each race.  
...
```{r fig3, fig.width=8, fig.height=6,cache=FALSE,warning=FALSE,message=FALSE,results="hide",fig.cap="\\label{fig:fig3}plotting by cancer"}
#split the maf data by clinical.race and plot summary for each category
...
From Figure \ref{fig:fig3}  we see that, 
...
```{r fig6, fig.width=6, fig.height=6,cache=FALSE,warning=FALSE,message=FALSE,results="hide", fig.cap="\\label{fig:fig6}plotting express"}
